...
private:
    ...
    frc::Mechanism2d m_mech{30,40};
        // the mechanism root node
    frc::MechanismRoot2d* m_root = m_mech.GetRoot("root", 15, 8);
    ...
    frc::MechanismLigament2d* m_elevator =
        m_root->Append<frc::MechanismLigament2d>("elevator", 6, 90_deg);
    frc::MechanismLigament2d* m_arm =
        m_elevator->Append<frc::MechanismLigament2d>("arm", 6, 0_deg, 6, frc::Color8Bit{frc::Color::kGreen});
    frc::MechanismLigament2d* m_wrist =
        m_arm->Append<frc::MechanismLigament2d>(
            "wrist", 6, 0_deg, 6, frc::Color8Bit{frc::Color::kPurple});

    frc::MechanismRoot2d* m_xbarRoot = m_mech.GetRoot("xbroot", 15, 22);
    frc::MechanismLigament2d* m_crossbar =
        m_xbarRoot->Append<frc::MechanismLigament2d>("cross bar", 1, 90_deg, 30, frc::Color8Bit{frc::Color::kRed});
